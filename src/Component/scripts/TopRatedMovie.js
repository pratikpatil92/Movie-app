...
class TopRatedMovie extends Component {
  ...
  render() {
    ...
    if (
      to_rated_movies.data_state == "NOT_INITIALIZED" ||
      to_rated_movies.data_state == "FETCHING"
    ) {
      return (
        <div>
...
export default connect(mapStateToProps, { getTopRatedMovies })(
  withRouter(TopRatedMovie)
);
